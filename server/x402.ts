...
export function buildPaymentRequired(
  ...
  const input = {
    ...
    reviewedArtifactName: {
      ...
      required: false,
      carrier: 'body',
      description: 'Flat alias for reviewedArtifact.name.',
    },
    reviewedCommit: {
      type: 'string',
      required: false,
      carrier: 'body',
      description: 'Flat alias for reviewedArtifact.reviewedCommit.',
    },
    reviewedRuntimeCodeHash: {
      ...
      description: 'Flat alias for reviewedArtifact.runtimeCodeHash.',
    },
    reviewedImplementationAddress: {
      ...
      carrier: 'body',
      pattern: '^0x[a-fA-F0-9]{40}$',
      description: 'Flat alias for reviewedArtifact.implementationAddress.',
    },
    reviewedImplementationCodeHash: {
      ...
      carrier: 'body',
      pattern: '^0x[a-fA-F0-9]{64}$',
      description: 'Flat alias for reviewedArtifact.implementationCodeHash.',
    },
    relatedContracts: {
      type: 'array',
      required: false,
