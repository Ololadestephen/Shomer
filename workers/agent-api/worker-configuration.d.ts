/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/agent-api/wrangler.toml workers/agent-api/worker-configuration.d.ts` (hash: 761139fda9a68596052665bc38747361)
// Runtime types generated with workerd@1.20260710.1 2026-07-22 nodejs_compat
interface __BaseEnv_Env {
	SHOMER_RECEIPTS: D1Database;
	X402_NETWORK: "xlayer";
	X402_PRICE_USD: "0.05";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "X402_NETWORK" | "X402_PRICE_USD" | "X402_ASSET" | "X402_ASSET_NAME" | "X402_ASSET_VERSION" | "X402_DEV_BYPASS" | "X402_FACILITATOR_URL" | "SERVICE_NAME">> {}
}
